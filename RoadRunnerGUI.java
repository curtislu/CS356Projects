    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (comStr.equals("Run Program")) {
            try {
               ...
               //System.out.print("Exeption occured while trying to complie RoadRunner using ant");
               e.printStackTrace();
            }
        }
        ...
        if (comStr.equals("Documentation")) {
            try {
                ...
                Process p = Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler C:\\Users\\Curtis\\Desktop\\RoadRunner-master\\RDAF.pdf");
                p.waitFor();
